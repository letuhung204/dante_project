...
<header class="site-header">
            ...
            <div class="container">
                ...
                <nav class="site-nav">
                    <ul class="site-nav-menu" data-menu-type="desktop">
                        ...
                        <li>
                            <a class="site-nav-link   " href="https://app.upserve.com/s/dante-west-village-new-york"
                               target="_blank" rel="noopener">TO-GO · CAFFE DANTE</a>
                        </li>
                        <li>
                            <a class="site-nav-link   " href="https://dante-101040.square.site/" target="_blank"
                               rel="noopener">TO-GO · WEST VILLAGE</a>
                        </li>
                        <li>
                            <a class="site-nav-link " href="/menus/">Caffe Dante Menu</a>
                        </li>
                        <li>
                            <a class="site-nav-link " href="/wv/">West Village Menu</a>
                        </li>
                        <li>
                            <a class="site-nav-link " href="/wv-1/">Dante Snow Lodge</a>
                        </li>
                        <li>
                            <a class="site-nav-link " href="/store/">Store</a>
                        </li>
                    </ul>
                </nav>
            </div>
    ...
    <div class="site-header-mobi" role="dialog" aria-modal="true" aria-label="Navigation Menu Modal">
        <div class="site-logo">
            <a class="site-logo__btn" href="/">
                <img src="https://images.getbento.com/accounts/e8eee6aef7c2e8242e267a82a199ac35/media/images/18365dante-cream.png"
                     alt="Caffe Dante Home" />
            ...
            <div class="site-header-mobi-panel__inner">
                <nav class="site-nav" aria-label="Navigation Menu">
                    <ul class="site-nav-menu" data-menu-type="mobile">
                        ...
                        <li>
                            <a class="site-nav-link" href="/email-signup/">Email Signup</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a class="site-nav-link" href="/store/gift-cards/">Gift Cards</a>
                        </li>
                        <li>
                            <a class="site-nav-link" href="/news-and-events/">Pop Ups</a>
                        </li>
                        <li>
                            <a class="site-nav-link" href="/celebrate/">Celebrate</a>
                        </li>
                        <li>
                            <a class="site-nav-link" href="/press/">Press</a>
                        </li>
                    </ul>
                </nav>
                <div class="site-social site-social--bordered">
                    <ul class="social-accounts">
                        <li><a href="https://www.facebook.com/dantenewyorkcity" target="_blank" rel="noopener"
                               ...
                               data-bb-track-label="Facebook, Header"><span class="fa fa-facebook"
                        ...
                        <li><a href="https://open.spotify.com/playlist/04PcJHvCBlIiwOlzex4Dxw" target="_blank"
                               ...
                               data-bb-track-category="Social Icons" data-bb-track-action="Click"
                               data-bb-track-label="spotify, Header"><span class="fa fa-spotify"
                                                                           aria-hidden="true"></span><span class="sr-only">spotify</span></a></li>
                    </ul>
                </div>
            </div>
            <div class="site-powered-by">
                <a href="https://getbento.com/?utm_source=header&amp;utm_campaign=dante-nyc.com" target="_blank"
